const Login = () => {
  return (
    <div className=" max-w-360 max-h-256 bg-linear-to-br from-[#a6c0fe] to-[#ffeaf6] m-auto ">
      <div className="p-26.25 flex ml-6 ">
        <section className="w-152.75 h-174.5   z-0 bg-white flex flex-col pt-[42px] rounded-4xl">
          ...
          <div className="text-slate-600 text-[16.89px] text-center font-normal">
        ...
        <section className="w-145.5 bg-white flex flex-col z-1 border border-slate-300 rounded-4xl -ml-6">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-col gap-1 mt-3">
                ...
                <div className="relative ">
                  <button className="w-full h-12.5 py-2.5 text-center text-4 font-medium text-white bg-[#0c28b7] border border-slate-400
              ...
              <div className="w-57 h-15 mt-10 mx-auto ">
                ...
                <div className="text-sm text-center mt-5">
                  <p>এখনও অ্যাকাউন্ট তৈরি করেননি? <span className="text-blue-500">রেজিস্টার </span></p>
                </div>
              </div>
            </div>
          </div>
